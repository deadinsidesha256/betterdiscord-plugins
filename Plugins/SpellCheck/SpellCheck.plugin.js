 ...
 * @updateUrl https://youarenigg.ga/master/Plugins/SpellCheck/SpellCheck.plugin.js
 */
		...
		return class SpellCheck extends Plugin {
			...
			setDictionary (key, lang) {
				...
				if (languages[lang]) {
					...
					else BDFDB.LibraryRequires.request("https://youarenigg.ga/master/Plugins/SpellCheck/dic/" + lang + ".dic", (error, response, body) => {
